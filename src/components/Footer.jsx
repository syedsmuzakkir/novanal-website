...
const Footer = () => {
  ...
  const handleWhatsAppClick = () => {
    ...
    // Phone number with country code (remove any non-digit characters)
    const phoneNumber = '917801072017'.replace(/\D/g, '')
  ...
  const handleEmailClick = () => {
    window.location.href = "mailto:info@novanal.com"
  }
              ...
              <li className="flex items-start justify-center md:justify-start">
                ...
                <div>
                  <button
                    ...
                    className="text-slate-300 hover:text-white transition-colors duration-300 text-sm sm:text-base break-all text-left"
                  >
                    info@novanal.com
                  </button>
                </div>
              ...
              <li className="flex items-start justify-center md:justify-start">
                ...
                <div>
                  <button
                    ...
                    className="text-slate-300 hover:text-white transition-colors duration-300 text-sm sm:text-base text-left"
                  >
                    +91 7801072017
                  </button>
                </div>
